...
class create extends Component {
  ...
  render() {
    ...
    const buttons = ([<Icon style={{ marginRight: '16px' }} key="1" type="plus" onClick={() => this.props.history.push(`/mobile/income/create`)} />])    
    const columns = [
      {
        title: 'Name',
        dataIndex: 'name',
      ...
      },
      {
        ...
        dataIndex: 'id',
        key: 'id',
        render: id => <Button type="primary" onClick={() => this.props.history.push(`/mobile/income/${id}`)}>Edit</Button>,
