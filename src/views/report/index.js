...
class create extends Component {
  ...
  render() {
    ...
    const buttons = (<Button onClick={() => this.props.history.push(`${link}/create`)} icon={<PlusCircleTwoTone />} type="primary" style={{ float: "right" }} >New</Button>)
    const columns = [
      {
        title: 'Name',
        dataIndex: 'name',
      ...
      },
      {
        ...
        dataIndex: 'id',
        key: 'id',
        render: id => <Button type="primary" onClick={() => this.props.history.push(`/${link}/${id}`)}>Edit</Button>,
    ...
    return (
      <Base buttons={buttons} title={link} subtitle="Report" >
        <Row>
          <Col span={18}>
